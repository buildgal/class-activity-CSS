...
# Differences from the Instructions in this code 

* In this style.css all the colors do not match the instructions. The font colors used in this CSS file are used to create a contrast. 

* Black, Orange, and Red are the font colors used in this file. 

* Additional padding was added to the #main-bio, #contact-info, and #bio-image to adjust the spacing between each element. 
